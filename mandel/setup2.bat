...
echo Adding the folder containing cuda.h to your system's INCLUDE environment variable...
for /f "delims=" %%i in ("!cuda_h_path!") do set "folder_path=%%~dpi"
setx INCLUDE "!folder_path!;%%INCLUDE%%"
echo Folder added to INCLUDE: !folder_path!
